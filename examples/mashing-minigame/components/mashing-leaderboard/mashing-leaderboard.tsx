...
import { useIntervalFetchMashingLeaderboard, OrgUserCounterType, OrgUserCounterTypeConnection } from './hooks.ts'
...
export default function MashingLeaderboard({ endTime, orgUserCounterTypeId }: MashingLeaderboardProps) {
...
function LeaderboardRows({ leaderboard }: { leaderboard: OrgUserCounterTypeConnection }) {
