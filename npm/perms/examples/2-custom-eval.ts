import { PermEvalFunc, PermsProcessor, perm, permEval } from "../src";
...
processor.register(permEval({ action: "doc.read", hasPermission: canAccessDoc }));
...
const user1Perms = [perm({ action: "doc.read", params: { docId: "123" } })];
const user2Perms = [perm({ action: "doc.read", params: { docId: "321" } })];
