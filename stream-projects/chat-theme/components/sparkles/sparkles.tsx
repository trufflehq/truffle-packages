...
const SPARKLE_PATHS = [
  ...
  "M34.1053 0L38.7597 34.9729L68.2105 40.5L38.7597 46.0271L34.1053 81L29.4509 46.0271L0 40.5L29.4509 34.9729L34.1053 0Z",
...
export default function Sparkles({ color = "#FF38D3", children }) {
  ...
  const [sparkles, setSparkles] = useState(() => {
    return range(20).map(() => generateSparkle(color));
  });
  ...
  useRandomInterval(
    () => {
      ...
      const newSparkles = range(10).map(() => {
