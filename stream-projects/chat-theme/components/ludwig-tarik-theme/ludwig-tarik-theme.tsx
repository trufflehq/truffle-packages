    ...
    layoutConfigSteps: [
      {
        ...
        value: {
          ...
          :root {
            ...
            --yt-live-chat-action-panel-background-color: #222222 !important;
          ...
          /*yt-live-chat-message-input-renderer::before {
            ...
            left: 0;
            z-index: -1;
            background-image: url(https://cdn.bio/assets/images/features/browser_extension/chat-themes/ludwig-tarik/chat_bottombar_bg.png);
            background-size: 100%;
          }
    ...
    layoutConfigSteps: [
      {
        ...
        value: {
          ...
          :root {
            ...
            --yt-spec-brand-background-primary: #222222 !important;
