...
export default function Avatar ({ user, src, rotation, size = DEFAULT_SIZE }) {
  ...
  if (!src) {
    ...
    src = `data:image/svg+xml,%3Csvg width='32' height='32' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='none' d='M-1-1h582v402H-1z'/%3E%3Cg%3E%3Cpath d='M16 8a4 4 0 014 4 4 4 0 01-4 4 4 4 0 01-4-4 4 4 0 014-4m0 10c4.42 0 8 1.79 8 4v2H8v-2c0-2.21 3.58-4 8-4z' fill='${placeholderFill}'/%3E%3C/g%3E%3C/svg%3E`
  }

  // w/o data is legacy. can probably rm in 2022
  const aspectRatio = user?.avatarImage?.data?.aspectRatio || user?.avatarImage?.aspectRatio
