...
export const getYouTubeOAuthUrl = async (accessToken: string, orgId: string) => {
...
export const getOAuthUrl = (sourceType: OAuthSourceType, accessToken: string, orgId: string) => sourceType === 'youtube' ? getYouTubeOAuthUrl(accessToken, orgId) : ''
